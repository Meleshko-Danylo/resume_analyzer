    ...
    return (
        <div className="App-wrapper">
            ...
            <div className="App flex items-center justify-center p-2">
                <div className={"rounded-3xl w-[95%] p-8 flex gap-6 items-center justify-center flex-col"}>
                    <div className={"flex items-center gap-6"}>
                        ...
                        <a target="_blank" href={"/Minimalist_Resume_Template.pdf"} className={"btn-2"}>Open pdf</a>
                        <a href={"/Minimalist_Resume_Template.pdf"} className={"btn-2"} download>Download pdf</a>
                    </div>
                    <embed
                        type={"application/pdf"}
                        src="/Minimalist_Resume_Template.pdf#toolbar=0&view=Fit"
                        className={"rounded-2xl w-[30vw] h-[700px]"}
                        style={{ border: 'none' }}
                    />
                </div>
            </div>
